...
namespace Cosmos.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,GenreId,Name,Description,Image")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GenreId,Name,Description,Image")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
